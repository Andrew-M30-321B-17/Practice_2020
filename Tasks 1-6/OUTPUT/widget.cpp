    ...
    ui(new Ui::Widget)
{
    ...
    connect(ui->horizontalSlider, SIGNAL(valueChanged(int)),this, SLOT(sl1Change()));
    connect(ui->horizontalSlider_2, SIGNAL(valueChanged(int)),this, SLOT(sl2Change()));
...
void Widget::pB5Clicked(){
    GetVisualFromCH Car(ui);
    Car.charts("Simple","blue",ui->widget,0);

}
void Widget::sl1Change(){

    ui->lineEdit_3->setText(QString::number(ui->horizontalSlider->value()));
}
void Widget::sl2Change(){

 ui->lineEdit_4->setText(QString::number(ui->horizontalSlider_2->value()));
}
